...
<template>
    <div>
        <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mx-4 sm:mx-6 my-8 p-10 shadow-lg">
            <div v-for="(product, index) in displayedProducts" :key="product.id" data-aos="fade-up"
                ...
                <!-- Content Container -->
                <div class="p-4">
                    <h3 class="text-lg font-sans text-gray-800 mb-2">{{ product.title }}</h3>
