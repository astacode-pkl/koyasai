<template>
  ...
  <div class="max-w-6xl mx-auto px-4 py-16">
    ...
    >
      ...
      <div class="mt-7">
        <h2
          class="text-2xl font-semibold text-orange-500 mb-4 text-center sm:text-left"
          data-aos="fade-right"
      ...
      <div>
        <h2
          class="text-2xl font-semibold text-orange-500 mb-4 mt-7 text-center sm:text-left"
          data-aos="fade-right"
          data-aos-duration="3000"
        >
          Contact Info
        ...
        <!-- Address Section -->
        <div
          class="flex items-start space-x-5 mb-4 mt-10"
          data-aos="fade-up"
        ...
        <!-- Phone Section -->
        <div
          class="flex items-start space-x-5 mb-4"
          data-aos="fade-up"
          data-aos-duration="2000"
          data-aos-delay="400"
        >
    ...
    >
      <div class="max-w-4xl mx-auto p-6">
        <h2 class="text-2xl font-semibold mb-6 text-center sm:text-center">
          Send Us <span class="text-orange-500">A Message</span>
        </h2>
